...
(12,    'btn-color'),
(12,    'btn-hover-border-style'),
(12,    'btn-hover-border-width'),
(12,    'btn-hover-border-color'),
(12,    'btn-hover-box-shadow'),
(12,    'btn-hover-background-color'),
(12,    'btn-hover-color'),
(12,    'button-border-style'),
(12,    'button-border-width'),
(12,    'button-border-color'),
(12,    'button-border-radius'),
(12,    'button-background-color'),
(12,    'button-color'),
(12,    'button-hover-border-style'),
(12,    'button-hover-border-width'),
(12,    'button-hover-border-color'),
